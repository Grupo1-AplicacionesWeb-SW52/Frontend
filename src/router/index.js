...
import SearchPage from '../search-caregivers/pages/search-page.vue';
import PaymentPageComponent from '../payment/pages/payment-page.component.vue';
import ReservationsPageComponent from '../reservations/pages/reservations-page.component.vue';
